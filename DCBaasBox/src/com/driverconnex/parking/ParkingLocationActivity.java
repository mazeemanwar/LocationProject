 ...
 * 
 * @author Adrian Klimczak NOT USED ANYMORE
 */
...
public class ParkingLocationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getIntent().getExtras() != null)
			parkedLocation = getIntent().getExtras().getParcelable(
					"parkedLocation");
	...
	private void locationInit() {
		...
		if (!networkEnabled && !gpsEnabled) {
			...
			LatLng lat = new LatLng(parkedLocation.getLatitude(),
					parkedLocation.getLongitude());
			marker.position(lat);
