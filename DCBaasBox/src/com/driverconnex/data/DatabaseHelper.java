...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE " + EXPENSE_TABLE + " (" + EXPENSE_ID
				...
				+ EXPENSE_IS_VAT + " BOOLEAN, " + EXPENSEIS_BUSINESS
				+ " BOOLEAN, " + EXPENSE_PICPATH + " TEXT, " + FUEL_VOLUME
				+ " DOUBLE, " + FUEL_MILEAGE + " INTEGER, " + EXPENSE_VEHICLE
				+ " TEXT, " + KPMG_HOURS + " TEXT, " + KPMG_CLAIMED + " TEXT)");
		...
		db.execSQL("CREATE TABLE " + JOURNEY_TABLE + " (" + JOURNEY_ID
				...
				+ JOURNEY_START_ADDR + " TEXT, " + JOURNEY_END_ADDR + " TEXT, "
		...
		db.execSQL("CREATE TABLE " + BEHAVIOUR_TABLE + " (" + BEHAVIOUR_ID
				...
				+ BEHAVIOUR_ACCELERATION_Z + " DOUBLE, " + BEHAVIOUR_ACTIVITY
