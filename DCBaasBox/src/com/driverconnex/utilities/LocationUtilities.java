...
public class LocationUtilities 
{
	 ...
	 */
	public static String getDistFromGoogleMaps(double lat1, double lon1, double lat2, double lon2) 
	{
	    String distance = "";
	 ...
	 * @return
	 */
	public static Address getAddressFromPoint(Context context, DCJourneyPoint point) {
	...
	public static Address getAddress(Context context, double latitude, double longitude)
	{
		...
		if(Utilities.checkDataConnection(context))
		{
			...
			try 
			{
				...
				// Some addresses will not contain needed information, that's why we need to
	            ...
	            for(int i=0; i<addresses.size(); i++)
	            {
	            	...
	            	if(addresses.get(i).getPostalCode() != null)
	            	{
	            		...
	            		if(addresses.get(i).getLocality() == null)
	            		{
	            			...
	            			String locality = addresses.get(i).getAddressLine(0);
