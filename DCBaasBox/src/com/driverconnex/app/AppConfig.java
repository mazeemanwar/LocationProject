...
public class AppConfig {
	...
	private static String BOOK_A_SERVICE;

	private static String DRIVERLINE;
	private static String BOOK_DEMO;
	...
	public static String getBOOK_A_SERVICE() {
		return BOOK_A_SERVICE;
	}

	public static void setBOOK_A_SERVICE(String bOOK_A_SERVICE) {
		BOOK_A_SERVICE = bOOK_A_SERVICE;
	}

	public static String getDRIVERLINE() {
		return DRIVERLINE;
	}

	public static void setDRIVERLINE(String dRIVERLINE) {
		DRIVERLINE = dRIVERLINE;
	}

	public static String getBOOK_DEMO() {
		return BOOK_DEMO;
	}

	public static void setBOOK_DEMO(String bOOK_DEMO) {
		BOOK_DEMO = bOOK_DEMO;
	}
}
