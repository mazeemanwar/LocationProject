...
/**
 * Activity for updating just a single field of the DCVehicle, e.g. mileage or
 * finance.
 * 
			...
			public boolean onEditorAction(TextView v, int actionId,
				...
				if ((event != null && (event.getKeyCode() == KeyEvent.KEYCODE_ENTER))
					...
					if (!editText.getText().toString().isEmpty()) {
						switch (update) {
						case UPDATE_MILEAGE:
							vehicle.setCurrentMileage(Long.parseLong(editText
									.getText().toString()));
							break;
						case UPDATE_FINANCE:
							vehicle.setMonthlyFinance(Float.parseFloat(editText
									.getText().toString()));
							break;
						}
								...
								new BaasHandler<BaasDocument>() {
									...
									public void handle(
										...
										if (res.isSuccess()) {
											...
											switch (update) {
											case UPDATE_MILEAGE:
												doc.put("vehicleOdometer",
														vehicle.getCurrentMileage());
												break;
											case UPDATE_FINANCE:
												doc.put("vehicleMonthlyFinance",
						...
						// BaasDocument.deleteSync("BAAVehicle",
						// vehicle.getId(),
						// new BaasHandler<BaasDocument>() {
						//
						// @Override
						...
						// .getQuery("DCVehicle");
						// query.getInBackground(vehicle.getId(),
