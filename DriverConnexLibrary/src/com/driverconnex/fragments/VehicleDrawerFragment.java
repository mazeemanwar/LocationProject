...
/**
 * Vehicle drawer fragment. It displays a default vehicle menu. It's the menu displayed from the right side of the screen.
...
public class VehicleDrawerFragment extends Fragment 
{
    ...
    {
        mDrawerListView = (ScrollView) inflater.inflate(R.layout.fragment_vehicle_drawer, container, false);
        
        // Get views from the layout
        vehicleLayout = (LinearLayout) mDrawerListView.findViewById(R.id.vehicleLayout);
        alertsLayout = (LinearLayout) mDrawerListView.findViewById(R.id.alertsLayout);
        serviceLayout = (LinearLayout) mDrawerListView.findViewById(R.id.serviceLayout);
        
        vehicleText = (TextView) mDrawerListView.findViewById(R.id.modelTextView);
        regText = (TextView) mDrawerListView.findViewById(R.id.regNumberTextView);
        alertsTex = (TextView) mDrawerListView.findViewById(R.id.alertsTextView);
            ...
            vehicleParse.fetchInBackground(new GetCallback<ParseObject>()
            {
    			...
    			public void done(ParseObject object, ParseException e) 
    			{
    				if(e == null)
    				{
    		        	...
    		        	alertsTex.setText(""+vehicle.getAlertsCount() + " Vehicle Alerts");
    		        	
    		        	// Get photo from the parse
    					ParseFile photo = (ParseFile) object.get("vehiclePhoto");
    					byte[] data = null;
    					...
    					else 
    					{
    						...
    						Bitmap bmp = AssetsUtilities.readBitmapVehicle(vehicle.getPhotoSrc());
