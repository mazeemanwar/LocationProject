...
{	
	...
	public boolean onOptionsItemSelected(MenuItem item) 
	{
	    ...
	    {	
			...
			dialog = new TimePickerDialog(AddParkingLocationActivity.this, new TimePickerDialog.OnTimeSetListener() 
		    {
		        ...
		        public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) 
		        {
		        	 ...
		        	 // For some reason onTimeSet is called twice, so check if this is a first call and ignore the second
		             if(callCount == 1)   
		             {
			 				dialog.dismiss();
							...
							ParkingLocationDataSource dataSource = new ParkingLocationDataSource(AddParkingLocationActivity.this);
							// Open database
							dataSource.open();
							// Insert parking location into database
							dataSource.createParkingLocation(parkingLocation);
							// Close database
							dataSource.close();
							//--------------------
		    ...
		    }, hour, minute, DateFormat.is24HourFormat(AddParkingLocationActivity.this));
